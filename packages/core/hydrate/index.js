...
class BrxPagination {
  ...
  handlePaginationTargetClick(event) {
    ...
    const trigger = target.closest(DOMStrings$2.paginationTargetTrigger);
    if (trigger) {
...
class BrxScrim {
  constructor(hostRef) {
    ...
    this.active = undefined;
    this.controlledActive = undefined;
    this.currentActive = false;
    this.type = 'foco';
    this.closeElement = '[data-scrim-dismiss]';
  }
  syncCurrentActiveFromProps() {
    const targetValue = this.controlledActive !== TOKEN_UNCONTROLLED ? this.controlledActive : this.active;
    this.currentActive = targetValue !== null && targetValue !== void 0 ? targetValue : false;
  }
  setActive(isActive) {
  ...
  render() {
    return (hAsync(Host, Object.assign({}, this.baseAttributes), hAsync("slot", null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
