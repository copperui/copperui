...
| ------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | -------------------- |
| `alignLabel`        | `align-label`        |                                                                                                                                                                                                                                                              | `"right" \| "top"`                 | `undefined`          |
...
| `labelDisabled`     | `label-disabled`     |                                                                                                                                                                                                                                                              | `string`                           | `''`                 |
| `labelEnabled`      | `label-enabled`      |                                                                                                                                                                                                                                                              | `string`                           | `''`                 |
...
| `brxChange` | Emitted when the checked property has changed. | `CustomEvent<SwitchChangeEventDetail<string>>` |
| `brxFocus`  | Emitted when the checkbox has focus.           | `CustomEvent<void>`                            |
| `brxUpdate` | Emitted when the state has changed.            | `CustomEvent<SwitchUpdateEventDetail<string>>` |
